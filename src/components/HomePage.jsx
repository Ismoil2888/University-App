            ...
            <div key={post.id} className="post-card">
              ...
              <div className="post-auth-three-dot">
                <div className="post-author">
                  ...
                  />
                  <span style={{color: "black", fontWeight: "bolder"}}>{post.userName}</span>
                </div>
...
//               <div className="post-author">
//                 <img src={post.userAvatar || defaultAvatar} alt="User Avatar" style={{ width: "50px", height: "50px", objectFit: "cover", borderRadius: "50%" }} />
//                 <span style={{color: "black", fontWeight: "bolder"}}>{post.userName}</span>
//               </div>
...
//         <Link to="/searchpage"><FontAwesomeIcon icon={faSearch} className="footer-icon" /></Link>
//         <Link to="/post">
//            <FaPlusCircle className="footer-icon" />
//         </Link>
//         <Link to="/library"><FontAwesomeIcon icon={faBook} className="footer-icon" /></Link>
//         <Link to="/myprofile">
//           <img 
